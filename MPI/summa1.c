...
//Set a small value for testing,...
//and set a large value for collecting experimental data.


void printDiff(double **data1, double **data2,
	int n, int iListLength, float fListTol)
	{
